/**
 * Mapa de Colombia con burbujas por ciudad de origen + ranking.
 * Lo usan Rizoma › Cuentas de atacantes (respeta los filtros) y Rizoma › Reporte mensual.
 * `geo` = [{ city, count }]; `accounts` = cuentas con ciudad registrada.
 */
...
export default function CityMap({ geo = [], accounts = 0, title = 'Distribución geográfica de las cuentas identificadas' }) {
  ...
  return (
    <div className="card">
      ...
      <p className="text-sm text-gray-500 mt-0.5">De las {accounts} cuentas con ciudad registrada, provienen de:</p>
      {geo.length === 0 ? (
