...
/** Rizoma › Publicaciones: feed de las cuentas hostiles marcadas en los Explorer. */
export default function RizomaFeed() {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <span className="badge bg-red-100 text-red-700 text-xs">Publicaciones de las cuentas hostiles monitoreadas</span>
